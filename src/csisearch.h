...
public:
    csisearch(const int& n_, const bool& dd, const bool& da, const bool& fa, const bool& verb);
    int index, lhs, con_vars, intv_vars;
...
public:
    ...
    csisearch_heuristic(const int& n_,  const bool& dd, const bool& da, const bool& fa, const bool& verb);
