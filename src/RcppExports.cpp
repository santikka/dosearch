...
Rcpp::List initialize_csisearch(const std::vector<int>& dir_lhs, const std::vector<int>& dir_rhs, const Rcpp::StringVector& lab, const Rcpp::List& p_list, const std::vector<int>& q_vec, const Rcpp::List& label_map, const Rcpp::List& local_csi, const int& con_vars, const int& intv_vars, const int& n, const std::vector<int>& rules, const bool& draw_derivation, const bool& draw_all, const bool& formula, const bool& heuristic, const bool& cache, const bool& verbose);
RcppExport SEXP _dosearch_initialize_csisearch(SEXP dir_lhsSEXP, SEXP dir_rhsSEXP, SEXP labSEXP, SEXP p_listSEXP, SEXP q_vecSEXP, SEXP label_mapSEXP, SEXP local_csiSEXP, SEXP con_varsSEXP, SEXP intv_varsSEXP, SEXP nSEXP, SEXP rulesSEXP, SEXP draw_derivationSEXP, SEXP draw_allSEXP, SEXP formulaSEXP, SEXP heuristicSEXP, SEXP cacheSEXP, SEXP verboseSEXP) {
BEGIN_RCPP
...
BEGIN_RCPP
    ...
    Rcpp::traits::input_parameter< const bool& >::type verbose(verboseSEXP);
    rcpp_result_gen = Rcpp::wrap(initialize_dosearch(dir_lhs, dir_rhs, bi_lhs, bi_rhs, lab, p_list, q_vec, n, tr, sb, md_s, md_p, rules, draw_derivation, draw_all, derive_all, formula, heuristic, md_sym, verbose));
    return rcpp_result_gen;
END_RCPP
}

static const R_CallMethodDef CallEntries[] = {
    {"_dosearch_initialize_csisearch", (DL_FUNC) &_dosearch_initialize_csisearch, 17},
    {"_dosearch_initialize_dosearch", (DL_FUNC) &_dosearch_initialize_dosearch, 20},
    {NULL, NULL, 0}
};
